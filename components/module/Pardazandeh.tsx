...
const Pardazandeh = () => {
  ...
  return (
    <div className="w-full mt-[2rem] rounded-md shadow-lg mx-auto h-auto bg-[#FFFFFF] items-center relative px-4">
      <Swiper
        slidesPerView={5}
        spaceBetween={10}
        pagination={{
      ...
      <div className="absolute flex items-center justify-between w-full top-0 left-0 space-x-2 p-2 border-b-[1px] z-10">
        <div className="p-3">
          <h3 className="text-[22px] font-bold">پردازنده (CPU) </h3>
        </div>
