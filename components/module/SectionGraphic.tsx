...
const SectionGrapgic = () => {
  ...
  const data = datas.filter((item: any) => item.category === "کارت گرافیک");
  return (
    <div className="w-full rounded-md shadow-lg mx-auto h-auto bg-[#FFFFFF] items-center relative px-4">
      <Swiper
        slidesPerView={5}
        spaceBetween={10}
        pagination={{
      ...
      <div className="absolute flex items-center justify-between w-full top-0 left-0 space-x-2 p-2 border-b-[1px] z-10">
        <div className="p-3">
          <h3 className="text-[22px] font-bold">کارت گرافیک </h3>
        </div>
