  ...
  return (
    <div className="w-full sm:grid-cols-2 md:grid-cols-4 justify-items-start md:justify-items-start grid lg:grid-cols-6 custom:grid-cols-4 pt-10 pb-2">
      <section className="flex flex-col gap-[15px] mr-4 mb-[3.135rem]">
        <h5 className="text-[14px] md:text-[16px] text-[#333333] font-bold">
          لینک های مفید
        </h5>
        <ul className="flex flex-col gap-3">
          <Link href={"#"}>
            <li className="text-[12px] md:text-[14px] text-[#777777]">
              صفحه اصلی
            </li>
          </Link>
          <Link href={"#"}>
      ...
      <section className="mb-[1.135rem] mr-[20px] lg:mr-0 custom:mr-4">
        <h5 className="text-[14px] md:text-[16px] text-[#333333] font-bold mb-[20px]">
          تماس با ما
        </h5>
        <p className="text-[12px] md:text-[14px] text-[#777777] w-[350px] lg:w-[470px] sm:w-[590px] mb-[20px]">
          آدرس : تهران – جنت اباد جنوبی – بلوار لاله شرقی – نبش کوچه نسترن –
          مجتمع تجاری لاله – فروشگاه الماس
        </p>
        <p className="text-[12px] md:text-[14px] text-[#777777] w-[355px] sm:w-[378px] mb-[20px]">
          تلفن های تماس : ۰۲۱۴۶۱۳۸۵۱۸ – ۰۲۱۴۶۱۳۸۵۱۷ – ۰۹۱۲۸۳۳۱۶۰۱
        </p>
        <p className="text-[12px] md:text-[14px] text-[#777777] w-[350px] mb-[20px]">
          ساعات پاسخگویی فروشگاه الماس ویستا:
        </p>
        <p className="text-[12px] md:text-[14px] text-[#777777] w-[350px] sm:w-[390px] mb-[20px]">
