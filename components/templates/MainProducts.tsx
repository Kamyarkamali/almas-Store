...
const MainProducts = ({ products }: { products: Product[] }) => {
  ...
  const [selectedProduct, setSelectedProduct] = useState<Product | null>(null); // ذخیره محصول انتخاب‌شده
      ...
      {products.map((product) => {
        ...
        return (
          <div
            ...
            onMouseEnter={() =>
              product.image2 && setCurrentImage(product.image2)
            }
          ...
          >
            ...
            >
              {product.price === 0 ? "موجود نیست" : formatNumber(product.price)}{" "}
              تومان
            </p>
